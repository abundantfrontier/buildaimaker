...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "BAMPersistence",
            dependencies: ["BAMCore", "BAMModels", .product(name: "GRDB", package: "GRDB.swift")],
            path: "Packages/BAMPersistence/Sources/BAMPersistence"
        ),
        .target(
            name: "BAMDatasets",
            dependencies: ["BAMCore", "BAMModels", "BAMPersistence", .product(name: "GRDB", package: "GRDB.swift")],
            path: "Packages/BAMDatasets/Sources/BAMDatasets"
        ),
        .target(
            name: "BAMModelCatalog",
            dependencies: ["BAMCore", "BAMModels"],
            path: "Packages/BAMModelCatalog/Sources/BAMModelCatalog",
            resources: [.copy("Resources/models.json"), .copy("Resources/fixtures")]
        ),
        .target(
            name: "BAMJobs",
            dependencies: ["BAMCore", "BAMModels", "BAMPersistence", .product(name: "GRDB", package: "GRDB.swift")],
        ...
        .testTarget(
            ...
            dependencies: ["BAMPersistence", "BAMModels", "BAMCore", .product(name: "GRDB", package: "GRDB.swift")],
        ...
        .testTarget(
            name: "BAMJobsTests",
            dependencies: ["BAMJobs", "BAMModels", "BAMCore", "BAMPersistence", .product(name: "GRDB", package: "GRDB.swift")],
